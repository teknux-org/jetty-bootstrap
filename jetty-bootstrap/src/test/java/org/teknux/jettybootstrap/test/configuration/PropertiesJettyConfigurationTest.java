...
public class PropertiesJettyConfigurationTest {
    ...
    public void systemPropertiesTest() {
        ...
        System.setProperty(PropertiesJettyConfiguration.KEY_SSL_PRIVATEKEY_FORMAT, "pkcs8");
        System.setProperty(PropertiesJettyConfiguration.KEY_SSL_PRIVATEKEY_PATH, "./privatekey1.key");
        System.setProperty(PropertiesJettyConfiguration.KEY_SSL_PRIVATEKEY_PASSWORD, "keypassword1");
        System.setProperty(PropertiesJettyConfiguration.KEY_SSL_CERTIFICATE_FORMAT, "pkcs12");
        System.setProperty(PropertiesJettyConfiguration.KEY_SSL_CERTIFICATE_PATH, "./certificate1.crt");
        System.setProperty(PropertiesJettyConfiguration.KEY_SSL_CERTIFICATE_PASSWORD, "crtpassword1");
        ...
        Assert.assertEquals("keypassword1", cfg.getSslPrivateKeyPassword());
        Assert.assertEquals(JettySslFileFormat.PKCS12, cfg.getSslCertificateFormat());
        Assert.assertEquals("./certificate1.crt", cfg.getSslCertificatePath());
        Assert.assertEquals("crtpassword1", cfg.getSslCertificatePassword());
        ...
        properties.setProperty(PropertiesJettyConfiguration.KEY_SSL_PRIVATEKEY_FORMAT, "pkcs12");
        properties.setProperty(PropertiesJettyConfiguration.KEY_SSL_PRIVATEKEY_PATH, "./privatekey2.key");
        properties.setProperty(PropertiesJettyConfiguration.KEY_SSL_PRIVATEKEY_PASSWORD, "keypassword2");
        properties.setProperty(PropertiesJettyConfiguration.KEY_SSL_CERTIFICATE_FORMAT, "pkcs8");
        properties.setProperty(PropertiesJettyConfiguration.KEY_SSL_CERTIFICATE_PATH, "./certificate2.crt");
        properties.setProperty(PropertiesJettyConfiguration.KEY_SSL_CERTIFICATE_PASSWORD, "crtpassword2");
        ...
        Assert.assertEquals("keypassword2", cfg.getSslPrivateKeyPassword());
        Assert.assertEquals(JettySslFileFormat.PKCS8, cfg.getSslCertificateFormat());
        Assert.assertEquals("./certificate2.crt", cfg.getSslCertificatePath());
        Assert.assertEquals("crtpassword2", cfg.getSslCertificatePassword());
